...
const EPS_END   = 0.3f0
const EPS_DECAY = 500
const NUM_EPOCHS = 19000
const BATCH_SIZE = 5
const REPLAY_CAPACITY = 200
const TARGET_SYNC_INTERVAL = 500
const LR = 1e-4
...
Q, losses = dqn(env, NUM_EPOCHS)
render(env)
plot(losses, xlabel="Epoch", ylabel="Loss", title="DQN Training Loss")

using JLD2, FileIO
@save "best_dqn_model.jld2" Q
